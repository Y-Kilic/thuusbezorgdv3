...
public class Order {
    ...
    private nl.hu.inno.thuusbezorgd.domain.OrderStatus status;

    public nl.hu.inno.thuusbezorgd.domain.OrderStatus getStatus() {
        return status;
    }
    ...
    public Order(User u, Address address) {
        ...
        this.status = nl.hu.inno.thuusbezorgd.domain.OrderStatus.Received;
    }
    ...
    public void setStatus(nl.hu.inno.thuusbezorgd.domain.OrderStatus status) {
        this.status = status;
    }
